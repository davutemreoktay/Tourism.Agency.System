...
public class AgentGUI extends JFrame {
    ...
    private JTabbedPane pnl_reservation_list;
    ...
    private JScrollPane scrl_hotel_list_top;
    ...
    private JTable tbl_room_feat;
    private JScrollPane scrl_room_feat;
    ...
    DefaultTableModel mdl_room_feats;
    private Object[] row_room_feats;
    ...
    public AgentGUI(){
        ...
        btn_hotel_add.addActionListener(e -> {
            HotelGUI hotelAdd=new HotelGUI(agent);
        ...
        mdl_room_feats = new DefaultTableModel(){
            @Override
            public boolean isCellEditable(int row, int column) {
                if (column == 0)
                    return false;
        ...
        Object[] col_room_feats = {"Oda Özellikleri", "Yatak Bilgisi", "Alan(m2)" };
        mdl_room_feats.setColumnIdentifiers(col_room_feats);
        row_room_feats = new Object[col_room_feats.length];
        //loadRoomFeatsModel();
        tbl_room_feat.setModel(mdl_room_feats);
        tbl_room_feat.getTableHeader().setReorderingAllowed(false);
        ...
        tbl_room_list.getSelectionModel().addListSelectionListener(e -> {
            ...
            loadRoomFeatsModel(select_room_id);
        ...
        btn_room_add.addActionListener(e -> {
            RoomAddGUI roomAddGUI = new RoomAddGUI(agent);
    ...
    private void loadRoomFeatsModel(int id) {
        DefaultTableModel clearModel = (DefaultTableModel) tbl_room_feat.getModel();
        clearModel.setRowCount(0);
        int i;
        for (RoomFeats obj : RoomFeats.getListByRoomID(id)){
            i = 0;
            row_room_feats[i++] = obj.getFeat();
            row_room_feats[i++] = obj.getBed();
            row_room_feats[i++] = obj.getArea();
            mdl_room_feats.addRow(row_room_feats);
        }
    }
